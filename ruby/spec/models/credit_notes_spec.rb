...
# Unit tests for LagoAPI::CreditNotes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LagoAPI::CreditNotes do
  let(:instance) { LagoAPI::CreditNotes.new }

  describe 'test an instance of CreditNotes' do
    it 'should create an instance of CreditNotes' do
      expect(instance).to be_instance_of(LagoAPI::CreditNotes)
    end
  end
