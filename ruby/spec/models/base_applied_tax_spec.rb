...
# Unit tests for LagoAPI::BaseAppliedTax
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LagoAPI::BaseAppliedTax do
  let(:instance) { LagoAPI::BaseAppliedTax.new }

  describe 'test an instance of BaseAppliedTax' do
    it 'should create an instance of BaseAppliedTax' do
      expect(instance).to be_instance_of(LagoAPI::BaseAppliedTax)
    end
  end
