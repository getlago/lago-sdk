...
# Unit tests for LagoAPI::CreditNoteAppliedTaxObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LagoAPI::CreditNoteAppliedTaxObject do
  let(:instance) { LagoAPI::CreditNoteAppliedTaxObject.new }

  describe 'test an instance of CreditNoteAppliedTaxObject' do
    it 'should create an instance of CreditNoteAppliedTaxObject' do
      expect(instance).to be_instance_of(LagoAPI::CreditNoteAppliedTaxObject)
    end
  end
  describe 'test attribute "lago_credit_note_id"' do
    it 'should work' do
