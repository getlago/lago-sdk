...
# Unit tests for LagoAPI::InvoiceObjectCustomer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LagoAPI::InvoiceObjectCustomer do
  let(:instance) { LagoAPI::InvoiceObjectCustomer.new }

  describe 'test an instance of InvoiceObjectCustomer' do
    it 'should create an instance of InvoiceObjectCustomer' do
      expect(instance).to be_instance_of(LagoAPI::InvoiceObjectCustomer)
    end
  end
