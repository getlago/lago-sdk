...
# Unit tests for LagoAPI::BillableMetricBaseInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LagoAPI::BillableMetricBaseInput do
  let(:instance) { LagoAPI::BillableMetricBaseInput.new }

  describe 'test an instance of BillableMetricBaseInput' do
    it 'should create an instance of BillableMetricBaseInput' do
      expect(instance).to be_instance_of(LagoAPI::BillableMetricBaseInput)
    end
  end
