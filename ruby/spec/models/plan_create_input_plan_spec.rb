...
# Unit tests for LagoAPI::PlanCreateInputPlan
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LagoAPI::PlanCreateInputPlan do
  let(:instance) { LagoAPI::PlanCreateInputPlan.new }

  describe 'test an instance of PlanCreateInputPlan' do
    it 'should create an instance of PlanCreateInputPlan' do
      expect(instance).to be_instance_of(LagoAPI::PlanCreateInputPlan)
    end
  end
