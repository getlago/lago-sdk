...
# Unit tests for LagoAPI::Organization
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LagoAPI::Organization do
  let(:instance) { LagoAPI::Organization.new }

  describe 'test an instance of Organization' do
    it 'should create an instance of Organization' do
      expect(instance).to be_instance_of(LagoAPI::Organization)
    end
  end
