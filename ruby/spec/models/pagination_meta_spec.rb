...
# Unit tests for LagoAPI::PaginationMeta
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LagoAPI::PaginationMeta do
  let(:instance) { LagoAPI::PaginationMeta.new }

  describe 'test an instance of PaginationMeta' do
    it 'should create an instance of PaginationMeta' do
      expect(instance).to be_instance_of(LagoAPI::PaginationMeta)
    end
  end
