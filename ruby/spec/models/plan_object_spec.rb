...
# Unit tests for LagoAPI::PlanObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LagoAPI::PlanObject do
  let(:instance) { LagoAPI::PlanObject.new }

  describe 'test an instance of PlanObject' do
    it 'should create an instance of PlanObject' do
      expect(instance).to be_instance_of(LagoAPI::PlanObject)
    end
  end
