...
# Unit tests for LagoAPI::CustomerCreateInputCustomer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LagoAPI::CustomerCreateInputCustomer do
  let(:instance) { LagoAPI::CustomerCreateInputCustomer.new }

  describe 'test an instance of CustomerCreateInputCustomer' do
    it 'should create an instance of CustomerCreateInputCustomer' do
      expect(instance).to be_instance_of(LagoAPI::CustomerCreateInputCustomer)
    end
  end
