...
# Unit tests for LagoAPI::CustomerObjectExtended
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LagoAPI::CustomerObjectExtended do
  let(:instance) { LagoAPI::CustomerObjectExtended.new }

  describe 'test an instance of CustomerObjectExtended' do
    it 'should create an instance of CustomerObjectExtended' do
      expect(instance).to be_instance_of(LagoAPI::CustomerObjectExtended)
    end
  end
