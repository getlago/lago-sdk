...
module LagoAPI
  class WalletCreateInputWallet
    ...
    def self.openapi_types
      {
        ...
        :'expiration_at' => :'Time',
        :'recurring_transaction_rules' => :'Array<WalletCreateInputWalletRecurringTransactionRulesInner>'
      }
    end
    ...
    def hash
      [name, rate_amount, currency, paid_credits, granted_credits, external_customer_id, expiration_at, recurring_transaction_rules].hash
    end
