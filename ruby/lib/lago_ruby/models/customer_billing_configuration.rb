...
module LagoAPI
  ...
  class CustomerBillingConfiguration
    ...
    attr_accessor :payment_provider_code
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'payment_provider_code')
        self.payment_provider_code = attributes[:'payment_provider_code']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          payment_provider_code == o.payment_provider_code &&
    ...
    def hash
      [invoice_grace_period, payment_provider, payment_provider_code, provider_customer_id, sync, sync_with_provider, document_locale, provider_payment_methods].hash
    end
