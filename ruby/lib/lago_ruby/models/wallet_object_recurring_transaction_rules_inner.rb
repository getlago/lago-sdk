...
module LagoAPI
  ...
  class WalletObjectRecurringTransactionRulesInner
    ...
    attr_accessor :threshold_credits
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LagoAPI::WalletObjectRecurringTransactionRulesInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LagoAPI::WalletObjectRecurringTransactionRulesInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@threshold_credits.nil? && @threshold_credits !~ pattern
        invalid_properties.push("invalid value for \"threshold_credits\", must conform to the pattern #{pattern}.")
      end

      if @paid_credits.nil?
        invalid_properties.push('invalid value for "paid_credits", paid_credits cannot be nil.')
      end
      ...
      if @granted_credits.nil?
        invalid_properties.push('invalid value for "granted_credits", granted_credits cannot be nil.')
      end
    ...
    def valid?
      ...
      rule_type_validator = EnumAttributeValidator.new('String', ["interval", "threshold"])
      ...
      return false if !@threshold_credits.nil? && @threshold_credits !~ Regexp.new(/^[0-9]+.?[0-9]*$/)
      return false if @paid_credits.nil?
      return false if @paid_credits !~ Regexp.new(/^[0-9]+.?[0-9]*$/)
      return false if @granted_credits.nil?
      return false if @granted_credits !~ Regexp.new(/^[0-9]+.?[0-9]*$/)
    ...
    def rule_type=(rule_type)
      validator = EnumAttributeValidator.new('String', ["interval", "threshold"])
    ...
    # @param [Object] threshold_credits Value to be assigned
    def threshold_credits=(threshold_credits)
      if threshold_credits.nil?
        fail ArgumentError, 'threshold_credits cannot be nil'
      end

      pattern = Regexp.new(/^[0-9]+.?[0-9]*$/)
      if threshold_credits !~ pattern
        fail ArgumentError, "invalid value for \"threshold_credits\", must conform to the pattern #{pattern}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          interval == o.interval &&
          threshold_credits == o.threshold_credits &&
    ...
    def hash
      [lago_id, rule_type, interval, threshold_credits, paid_credits, granted_credits, created_at].hash
    end
