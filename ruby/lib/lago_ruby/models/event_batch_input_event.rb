...
module LagoAPI
  class EventBatchInputEvent
    ...
    attr_accessor :external_subscription_ids
    ...
    def self.openapi_types
      {
        ...
        :'external_subscription_ids' => :'Array<String>',
        :'code' => :'String',
        :'timestamp' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LagoAPI::EventBatchInputEvent` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LagoAPI::EventBatchInputEvent`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'external_subscription_ids')
        if (value = attributes[:'external_subscription_ids']).is_a?(Array)
          self.external_subscription_ids = value
        end
      else
        self.external_subscription_ids = nil
      end
    ...
    def list_invalid_properties
      ...
      if @external_subscription_ids.nil?
        invalid_properties.push('invalid value for "external_subscription_ids", external_subscription_ids cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @external_subscription_ids.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          external_subscription_ids == o.external_subscription_ids &&
          code == o.code &&
    ...
    def hash
      [transaction_id, external_customer_id, external_subscription_ids, code, timestamp, properties].hash
    end
