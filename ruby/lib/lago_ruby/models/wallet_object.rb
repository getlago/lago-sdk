...
module LagoAPI
  class WalletObject
    ...
    attr_accessor :recurring_transaction_rules

    # The wallet ongoing balance expressed in cents.
    attr_accessor :ongoing_balance_cents

    # The wallet ongoing usage balance expressed in cents.
    attr_accessor :ongoing_usage_balance_cents

    # The wallet ongoing balance expressed in credits.
    attr_accessor :credits_ongoing_balance

    # The wallet ongoing usage balance expressed in credits.
    attr_accessor :credits_ongoing_usage_balance
    ...
    def self.openapi_types
      {
        ...
        :'terminated_at' => :'Time',
        :'recurring_transaction_rules' => :'Array<WalletObjectRecurringTransactionRulesInner>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'recurring_transaction_rules')
        if (value = attributes[:'recurring_transaction_rules']).is_a?(Array)
          self.recurring_transaction_rules = value
        end
      end

      if attributes.key?(:'ongoing_balance_cents')
        self.ongoing_balance_cents = attributes[:'ongoing_balance_cents']
      else
        self.ongoing_balance_cents = nil
      end

      if attributes.key?(:'ongoing_usage_balance_cents')
        self.ongoing_usage_balance_cents = attributes[:'ongoing_usage_balance_cents']
      else
        self.ongoing_usage_balance_cents = nil
      end

      if attributes.key?(:'credits_ongoing_balance')
        self.credits_ongoing_balance = attributes[:'credits_ongoing_balance']
      else
        self.credits_ongoing_balance = nil
      end

      if attributes.key?(:'credits_ongoing_usage_balance')
        self.credits_ongoing_usage_balance = attributes[:'credits_ongoing_usage_balance']
      else
        self.credits_ongoing_usage_balance = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ongoing_balance_cents.nil?
        invalid_properties.push('invalid value for "ongoing_balance_cents", ongoing_balance_cents cannot be nil.')
      end

      if @ongoing_usage_balance_cents.nil?
        invalid_properties.push('invalid value for "ongoing_usage_balance_cents", ongoing_usage_balance_cents cannot be nil.')
      end

      if @credits_ongoing_balance.nil?
        invalid_properties.push('invalid value for "credits_ongoing_balance", credits_ongoing_balance cannot be nil.')
      end

      pattern = Regexp.new(/^[0-9]+.?[0-9]*$/)
      if @credits_ongoing_balance !~ pattern
        invalid_properties.push("invalid value for \"credits_ongoing_balance\", must conform to the pattern #{pattern}.")
      end

      if @credits_ongoing_usage_balance.nil?
        invalid_properties.push('invalid value for "credits_ongoing_usage_balance", credits_ongoing_usage_balance cannot be nil.')
      end

      pattern = Regexp.new(/^[0-9]+.?[0-9]*$/)
      if @credits_ongoing_usage_balance !~ pattern
        invalid_properties.push("invalid value for \"credits_ongoing_usage_balance\", must conform to the pattern #{pattern}.")
      end
    ...
    def valid?
      ...
      return false if @ongoing_balance_cents.nil?
      return false if @ongoing_usage_balance_cents.nil?
      return false if @credits_ongoing_balance.nil?
      return false if @credits_ongoing_balance !~ Regexp.new(/^[0-9]+.?[0-9]*$/)
      return false if @credits_ongoing_usage_balance.nil?
      return false if @credits_ongoing_usage_balance !~ Regexp.new(/^[0-9]+.?[0-9]*$/)
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] credits_ongoing_balance Value to be assigned
    def credits_ongoing_balance=(credits_ongoing_balance)
      if credits_ongoing_balance.nil?
        fail ArgumentError, 'credits_ongoing_balance cannot be nil'
      end

      pattern = Regexp.new(/^[0-9]+.?[0-9]*$/)
      if credits_ongoing_balance !~ pattern
        fail ArgumentError, "invalid value for \"credits_ongoing_balance\", must conform to the pattern #{pattern}."
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] credits_ongoing_usage_balance Value to be assigned
    def credits_ongoing_usage_balance=(credits_ongoing_usage_balance)
      if credits_ongoing_usage_balance.nil?
        fail ArgumentError, 'credits_ongoing_usage_balance cannot be nil'
      end

      pattern = Regexp.new(/^[0-9]+.?[0-9]*$/)
      if credits_ongoing_usage_balance !~ pattern
        fail ArgumentError, "invalid value for \"credits_ongoing_usage_balance\", must conform to the pattern #{pattern}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          recurring_transaction_rules == o.recurring_transaction_rules &&
          ongoing_balance_cents == o.ongoing_balance_cents &&
          ongoing_usage_balance_cents == o.ongoing_usage_balance_cents &&
          credits_ongoing_balance == o.credits_ongoing_balance &&
          credits_ongoing_usage_balance == o.credits_ongoing_usage_balance
    end
