...
module LagoAPI
  class OrganizationUpdateInputOrganization
    ...
    def hash
      [webhook_url, country, default_currency, address_line1, address_line2, state, zipcode, email, city, legal_name, legal_number, document_numbering, document_number_prefix, net_payment_term, tax_identification_number, timezone, email_settings, billing_configuration].hash
    end
