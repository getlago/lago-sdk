  ...
  class CustomerUsageObject
    ...
    def self.openapi_types
      {
        ...
        :'charges_usage' => :'Array<CustomerChargeUsageObject>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LagoAPI::CustomerUsageObject` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LagoAPI::CustomerUsageObject`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'charges_usage')
        if (value = attributes[:'charges_usage']).is_a?(Array)
          self.charges_usage = value
        end
      else
        self.charges_usage = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @from_datetime.nil?
        invalid_properties.push('invalid value for "from_datetime", from_datetime cannot be nil.')
      end

      if @to_datetime.nil?
        invalid_properties.push('invalid value for "to_datetime", to_datetime cannot be nil.')
      end
      ...
      if @charges_usage.nil?
        invalid_properties.push('invalid value for "charges_usage", charges_usage cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @from_datetime.nil?
      return false if @to_datetime.nil?
      ...
      return false if @charges_usage.nil?
      true
    end
