...
module LagoAPI
  class CustomerChargeUsageObject
    ...
    def self.openapi_types
      {
        ...
        :'grouped_usage' => :'Array<CustomerChargeGroupedUsageObjectInner>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'grouped_usage')
        if (value = attributes[:'grouped_usage']).is_a?(Array)
          self.grouped_usage = value
        end
      end
    end
    ...
    def hash
      [units, events_count, amount_cents, amount_currency, charge, billable_metric, groups, grouped_usage].hash
    end
