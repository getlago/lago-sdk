...
// APIClient manages communication with the Lago API documentation API v0.52.0-beta
...
type APIClient struct {
	...
	BillableMetricsAPI *BillableMetricsAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.BillableMetricsAPI = (*BillableMetricsAPIService)(&c.common)
