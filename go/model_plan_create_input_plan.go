...
// checks if the PlanCreateInputPlan type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PlanCreateInputPlan{}

// PlanCreateInputPlan struct for PlanCreateInputPlan
type PlanCreateInputPlan struct {
	...
	Charges []PlanCreateInputPlanChargesInner `json:"charges,omitempty"`
}
...
func (o *PlanCreateInputPlan) SetBillChargesMonthlyNil() {
...
func (o *PlanCreateInputPlan) GetCharges() []PlanCreateInputPlanChargesInner {
	if o == nil || IsNil(o.Charges) {
		var ret []PlanCreateInputPlanChargesInner
		return ret
	}
	return o.Charges
}
...
// SetCharges gets a reference to the given []PlanCreateInputPlanChargesInner and assigns it to the Charges field.
func (o *PlanCreateInputPlan) SetCharges(v []PlanCreateInputPlanChargesInner) {
	o.Charges = v
}

func (o PlanCreateInputPlan) MarshalJSON() ([]byte, error) {
...
func (o PlanCreateInputPlan) ToMap() (map[string]interface{}, error) {
...
type NullablePlanCreateInputPlan struct {
	value *PlanCreateInputPlan
	isSet bool
}

func (v NullablePlanCreateInputPlan) Get() *PlanCreateInputPlan {
	return v.value
}

func (v *NullablePlanCreateInputPlan) Set(val *PlanCreateInputPlan) {
	v.value = val
	v.isSet = true
}

func (v NullablePlanCreateInputPlan) IsSet() bool {
	return v.isSet
}

func (v *NullablePlanCreateInputPlan) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePlanCreateInputPlan(val *PlanCreateInputPlan) *NullablePlanCreateInputPlan {
	return &NullablePlanCreateInputPlan{value: val, isSet: true}
}

func (v NullablePlanCreateInputPlan) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePlanCreateInputPlan) UnmarshalJSON(src []byte) error {
	v.isSet = true
