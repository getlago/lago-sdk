...
// checks if the GroupPropertiesObjectValues type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupPropertiesObjectValues{}

// GroupPropertiesObjectValues struct for GroupPropertiesObjectValues
type GroupPropertiesObjectValues struct {
...
func NewGroupPropertiesObjectValues() *GroupPropertiesObjectValues {
	this := GroupPropertiesObjectValues{}
	return &this
}
...
func (o *GroupPropertiesObjectValues) SetFreeUnitsPerEventsNil() {
...
func (o *GroupPropertiesObjectValues) SetFreeUnitsPerTotalAggregationNil() {
...
func (o *GroupPropertiesObjectValues) SetPerTransactionMaxAmountNil() {
...
func (o *GroupPropertiesObjectValues) SetPerTransactionMinAmountNil() {
...
func (o GroupPropertiesObjectValues) MarshalJSON() ([]byte, error) {
...
func (o GroupPropertiesObjectValues) ToMap() (map[string]interface{}, error) {
...
type NullableGroupPropertiesObjectValues struct {
	value *GroupPropertiesObjectValues
	isSet bool
}

func (v NullableGroupPropertiesObjectValues) Get() *GroupPropertiesObjectValues {
	return v.value
}

func (v *NullableGroupPropertiesObjectValues) Set(val *GroupPropertiesObjectValues) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupPropertiesObjectValues) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupPropertiesObjectValues) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupPropertiesObjectValues(val *GroupPropertiesObjectValues) *NullableGroupPropertiesObjectValues {
	return &NullableGroupPropertiesObjectValues{value: val, isSet: true}
}

func (v NullableGroupPropertiesObjectValues) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupPropertiesObjectValues) UnmarshalJSON(src []byte) error {
	v.isSet = true
