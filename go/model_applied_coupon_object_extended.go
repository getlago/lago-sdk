...
// checks if the AppliedCouponObjectExtended type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppliedCouponObjectExtended{}

// AppliedCouponObjectExtended struct for AppliedCouponObjectExtended
type AppliedCouponObjectExtended struct {
...
type _AppliedCouponObjectExtended AppliedCouponObjectExtended
...
func NewAppliedCouponObjectExtended(lagoId string, lagoCouponId string, couponCode string, couponName string, lagoCustomerId string, externalCustomerId string, status string, frequency string, createdAt time.Time, credits []CreditObject) *AppliedCouponObjectExtended {
	this := AppliedCouponObjectExtended{}
	this.LagoId = lagoId
...
func (o *AppliedCouponObjectExtended) SetAmountCentsNil() {
...
func (o *AppliedCouponObjectExtended) SetAmountCentsRemainingNil() {
...
func (o *AppliedCouponObjectExtended) SetPercentageRateNil() {
...
func (o *AppliedCouponObjectExtended) SetFrequencyDurationNil() {
...
func (o *AppliedCouponObjectExtended) SetFrequencyDurationRemainingNil() {
...
func (o *AppliedCouponObjectExtended) SetExpirationAtNil() {
...
func (o *AppliedCouponObjectExtended) SetTerminatedAtNil() {
...
func (o AppliedCouponObjectExtended) MarshalJSON() ([]byte, error) {
...
func (o AppliedCouponObjectExtended) ToMap() (map[string]interface{}, error) {
...
func (o *AppliedCouponObjectExtended) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAppliedCouponObjectExtended := _AppliedCouponObjectExtended{}

	err = json.Unmarshal(bytes, &varAppliedCouponObjectExtended)

	if err != nil {
		return err
	}

	*o = AppliedCouponObjectExtended(varAppliedCouponObjectExtended)

	return err
}

type NullableAppliedCouponObjectExtended struct {
	value *AppliedCouponObjectExtended
	isSet bool
}

func (v NullableAppliedCouponObjectExtended) Get() *AppliedCouponObjectExtended {
	return v.value
}

func (v *NullableAppliedCouponObjectExtended) Set(val *AppliedCouponObjectExtended) {
	v.value = val
	v.isSet = true
}

func (v NullableAppliedCouponObjectExtended) IsSet() bool {
	return v.isSet
}

func (v *NullableAppliedCouponObjectExtended) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppliedCouponObjectExtended(val *AppliedCouponObjectExtended) *NullableAppliedCouponObjectExtended {
	return &NullableAppliedCouponObjectExtended{value: val, isSet: true}
}

func (v NullableAppliedCouponObjectExtended) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppliedCouponObjectExtended) UnmarshalJSON(src []byte) error {
	v.isSet = true
