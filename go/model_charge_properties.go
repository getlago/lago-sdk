...
// checks if the ChargeProperties type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChargeProperties{}

// ChargeProperties struct for ChargeProperties
...
func (o *ChargeProperties) SetFreeUnitsPerEventsNil() {
...
func (o *ChargeProperties) SetFreeUnitsPerTotalAggregationNil() {
...
func (o *ChargeProperties) SetPerTransactionMaxAmountNil() {
...
func (o *ChargeProperties) SetPerTransactionMinAmountNil() {
...
func (o ChargeProperties) MarshalJSON() ([]byte, error) {
...
func (o ChargeProperties) ToMap() (map[string]interface{}, error) {
...
type NullableChargeProperties struct {
	value *ChargeProperties
	isSet bool
}

func (v NullableChargeProperties) Get() *ChargeProperties {
	return v.value
}

func (v *NullableChargeProperties) Set(val *ChargeProperties) {
	v.value = val
	v.isSet = true
}

func (v NullableChargeProperties) IsSet() bool {
	return v.isSet
}

func (v *NullableChargeProperties) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChargeProperties(val *ChargeProperties) *NullableChargeProperties {
	return &NullableChargeProperties{value: val, isSet: true}
}

func (v NullableChargeProperties) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChargeProperties) UnmarshalJSON(src []byte) error {
	v.isSet = true
