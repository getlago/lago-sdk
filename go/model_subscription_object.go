...
// checks if the SubscriptionObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionObject{}
...
func (o *SubscriptionObject) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *SubscriptionObject) SetCanceledAtNil() {
...
func (o *SubscriptionObject) SetStartedAtNil() {
	o.StartedAt.Set(nil)
}
...
func (o *SubscriptionObject) SetTerminatedAtNil() {
...
func (o *SubscriptionObject) SetPreviousPlanCodeNil() {
...
func (o *SubscriptionObject) SetNextPlanCodeNil() {
...
func (o *SubscriptionObject) SetDowngradePlanDateNil() {
...
func (o SubscriptionObject) ToMap() (map[string]interface{}, error) {
...
func (o *SubscriptionObject) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varSubscriptionObject)
