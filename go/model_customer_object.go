...
func (o *CustomerObject) SetAddressLine1Nil() {
...
func (o *CustomerObject) SetAddressLine2Nil() {
...
func (o *CustomerObject) SetCityNil() {
	o.City.Set(nil)
}
...
func (o *CustomerObject) SetLegalNameNil() {
	o.LegalName.Set(nil)
}
...
func (o *CustomerObject) SetLegalNumberNil() {
...
func (o *CustomerObject) SetLogoUrlNil() {
	o.LogoUrl.Set(nil)
}
...
func (o *CustomerObject) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *CustomerObject) SetPhoneNil() {
	o.Phone.Set(nil)
}
...
func (o *CustomerObject) SetStateNil() {
	o.State.Set(nil)
}
...
func (o *CustomerObject) SetTaxIdentificationNumberNil() {
...
func (o *CustomerObject) SetUrlNil() {
	o.Url.Set(nil)
}
...
func (o *CustomerObject) SetZipcodeNil() {
	o.Zipcode.Set(nil)
}
...
func (o *CustomerObject) SetNetPaymentTermNil() {
...
func (o *CustomerObject) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCustomerObject)
