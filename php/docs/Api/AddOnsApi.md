...
```php
createAddOn($add_on_create_input): \OpenAPI\Client\Model\AddOn
```
...
| ------------- | ------------- | ------------- | ------------- |
| **add_on_create_input** | [**\OpenAPI\Client\Model\AddOnCreateInput**](../Model/AddOnCreateInput.md)| Add-on payload | |
...
```php
updateAddOn($code, $add_on_update_input): \OpenAPI\Client\Model\AddOn
```
...
$code = setup_fee; // string | Unique code used to identify the add-on.
$add_on_update_input = new \OpenAPI\Client\Model\AddOnUpdateInput(); // \OpenAPI\Client\Model\AddOnUpdateInput | Add-on payload
...
| ------------- | ------------- | ------------- | ------------- |
| **code** | **string**| Unique code used to identify the add-on. | |
| **add_on_update_input** | [**\OpenAPI\Client\Model\AddOnUpdateInput**](../Model/AddOnUpdateInput.md)| Add-on payload | |
