...
```php
createPlan($plan_create_input): \OpenAPI\Client\Model\Plan
```
...
$plan_create_input = new \OpenAPI\Client\Model\PlanCreateInput(); // \OpenAPI\Client\Model\PlanCreateInput | Plan payload
...
| ------------- | ------------- | ------------- | ------------- |
| **plan_create_input** | [**\OpenAPI\Client\Model\PlanCreateInput**](../Model/PlanCreateInput.md)| Plan payload | |
...
```php
updatePlan($code, $plan_update_input): \OpenAPI\Client\Model\Plan
```
...
$code = startup; // string | The code of the plan. It serves as a unique identifier associated with a particular plan. The code is typically used for internal or system-level identification purposes, like assigning a subscription, for instance.
$plan_update_input = new \OpenAPI\Client\Model\PlanUpdateInput(); // \OpenAPI\Client\Model\PlanUpdateInput | Plan payload
...
| ------------- | ------------- | ------------- | ------------- |
| **code** | **string**| The code of the plan. It serves as a unique identifier associated with a particular plan. The code is typically used for internal or system-level identification purposes, like assigning a subscription, for instance. | |
| **plan_update_input** | [**\OpenAPI\Client\Model\PlanUpdateInput**](../Model/PlanUpdateInput.md)| Plan payload | |
