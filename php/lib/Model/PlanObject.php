...
class PlanObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param int $active_subscriptions_count The count of active subscriptions that are currently associated with the plan. This field provides valuable information regarding the impact of deleting the plan. By checking the value of this field, you can determine the number of subscriptions that will be affected if the plan is deleted.
     *
     * @return self
     */
     ...
     *
     * @param int $draft_invoices_count The number of draft invoices that include a subscription attached to the plan. This field provides valuable information about the impact of deleting the plan. By checking the value of this field, you can determine the number of draft invoices that will be affected if the plan is deleted.
     *
     * @return self
     */
     ...
     * Sets charges
     *
     * @param \OpenAPI\Client\Model\ChargeObject[]|null $charges Additional usage-based charges for this plan.
     *
     * @return self
     */
     ...
     * Sets taxes
     *
     * @param \OpenAPI\Client\Model\TaxObject[]|null $taxes All taxes applied to the plan.
     *
     * @return self
     */
