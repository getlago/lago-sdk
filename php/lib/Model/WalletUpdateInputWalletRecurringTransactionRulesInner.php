...
class WalletUpdateInputWalletRecurringTransactionRulesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets rule_type
     *
     * @param string|null $rule_type The rule type. Possible values are `interval` or `threshold`.
     *
     * @return self
     */
     ...
     * Sets interval
     *
     * @param string|null $interval The interval used for recurring top-up. It represents the frequency at which automatic top-up occurs. The interval can be one of the following values: `weekly`, `monthly`, `quarterly` or `yearly`. Required only when rule type is set to `interval`.
     *
     * @return self
     */
