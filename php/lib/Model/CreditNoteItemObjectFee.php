...
/**
 * CreditNoteItemObjectFee Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreditNoteItemObjectFee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditNoteItemObject_fee';
    ...
    protected static $openAPITypes = [
        ...
        'amount_details' => '\OpenAPI\Client\Model\FeeObjectAmountDetails',
        'item' => '\OpenAPI\Client\Model\FeeObjectItem',
        'applied_taxes' => '\OpenAPI\Client\Model\FeeAppliedTaxObject[]'
    ];
    ...
    */
     ...
     * Sets lago_group_id
     *
     * @param string|null $lago_group_id Unique identifier assigned to the group that the fee belongs to
     *
     * @return self
     */
    public function setLagoGroupId($lago_group_id)
    {
        if (is_null($lago_group_id)) {
            array_push($this->openAPINullablesSetToNull, 'lago_group_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('lago_group_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param Currency $amount_currency amount_currency
     *
     * @return self
     */
     ...
     *
     * @param Currency $total_amount_currency total_amount_currency
     *
     * @return self
     */
     ...
     * Gets amount_details
     *
     * @return \OpenAPI\Client\Model\FeeObjectAmountDetails|null
     */
     ...
     * Sets amount_details
     *
     * @param \OpenAPI\Client\Model\FeeObjectAmountDetails|null $amount_details amount_details
     *
     * @return self
     */
     ...
     * Gets applied_taxes
     *
     * @return \OpenAPI\Client\Model\FeeAppliedTaxObject[]|null
     */
     ...
     * Sets applied_taxes
     *
     * @param \OpenAPI\Client\Model\FeeAppliedTaxObject[]|null $applied_taxes List of fee applied taxes
     *
     * @return self
     */
