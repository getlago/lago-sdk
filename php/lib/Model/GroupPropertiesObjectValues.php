...
/**
 * GroupPropertiesObjectValues Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GroupPropertiesObjectValues implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GroupPropertiesObject_values';
    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if ((!preg_match("/^[0-9]+.?[0-9]*$/", ObjectSerializer::toString($amount)))) {
            throw new \InvalidArgumentException("invalid value for \$amount when calling GroupPropertiesObjectValues., must conform to the pattern /^[0-9]+.?[0-9]*$/.");
        }
    ...
    public function setRate($rate)
    {
        ...
        if ((!preg_match("/^[0-9]+.?[0-9]*$/", ObjectSerializer::toString($rate)))) {
            throw new \InvalidArgumentException("invalid value for \$rate when calling GroupPropertiesObjectValues., must conform to the pattern /^[0-9]+.?[0-9]*$/.");
        }
    ...
    public function setFixedAmount($fixed_amount)
    {
        ...
        if ((!preg_match("/^[0-9]+.?[0-9]*$/", ObjectSerializer::toString($fixed_amount)))) {
            throw new \InvalidArgumentException("invalid value for \$fixed_amount when calling GroupPropertiesObjectValues., must conform to the pattern /^[0-9]+.?[0-9]*$/.");
        }
    ...
    public function setFreeUnitsPerTotalAggregation($free_units_per_total_aggregation)
    {
        ...
        if (!is_null($free_units_per_total_aggregation) && (!preg_match("/^[0-9]+.?[0-9]*$/", ObjectSerializer::toString($free_units_per_total_aggregation)))) {
            throw new \InvalidArgumentException("invalid value for \$free_units_per_total_aggregation when calling GroupPropertiesObjectValues., must conform to the pattern /^[0-9]+.?[0-9]*$/.");
        }
