...
class BillableMetricObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param int $active_subscriptions_count Number of active subscriptions using this billable metric.
     *
     * @return self
     */
     ...
     *
     * @param int $draft_invoices_count Number of draft invoices for which this billable metric is listed as an invoice item.
     *
     * @return self
     */
     ...
     * Sets plans_count
     *
     * @param int $plans_count Number of plans using this billable metric.
     *
     * @return self
     */
