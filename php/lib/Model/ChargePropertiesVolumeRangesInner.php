...
class ChargePropertiesVolumeRangesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets flat_amount
     *
     * @param string $flat_amount The unit price, excluding tax, for a specific tier of a `volume` charge model. It is expressed as a decimal value.
     *
     * @return self
     */
     ...
     *
     * @param string $per_unit_amount The flat amount for a whole tier, excluding tax, for a `volume` charge model. It is expressed as a decimal value.
     *
     * @return self
     */
