...
/**
 * TaxCreateInputTax Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TaxCreateInputTax implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaxCreateInput_tax';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[0-9]+.?[0-9]*$/", $this->container['rate'])) {
     ...
     * Sets rate
     *
     * @param string $rate The percentage rate of the tax
     *
     * @return self
     */
    public function setRate($rate)
    {
        ...
        if ((!preg_match("/^[0-9]+.?[0-9]*$/", ObjectSerializer::toString($rate)))) {
            throw new \InvalidArgumentException("invalid value for \$rate when calling TaxCreateInputTax., must conform to the pattern /^[0-9]+.?[0-9]*$/.");
        }
     ...
     *
     * @param bool|null $applied_to_organization Set to `true` if the tax is used as one of the organization's default
     *
     * @return self
     */
