...
class InvoiceObjectExtended implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'version_number' => 'int',
        'file_url' => 'string',
        'customer' => '\OpenAPI\Client\Model\InvoiceObjectCustomer',
        'metadata' => '\OpenAPI\Client\Model\InvoiceMetadataObject[]',
        'applied_taxes' => '\OpenAPI\Client\Model\InvoiceAppliedTaxObject[]',
    ...
    */
     ...
     * Sets sequential_id
     *
     * @param int $sequential_id This ID helps in uniquely identifying and organizing the invoices associated with a specific customer. It provides a sequential numbering system specific to the customer, allowing for easy tracking and management of invoices within the customer's context.
     *
     * @return self
     */
     ...
     * Sets invoice_type
     *
     * @param string $invoice_type The type of invoice issued. Possible values are `subscription`, `one-off` or `credit`.
     *
     * @return self
     */
     ...
     * Gets customer
     *
     * @return \OpenAPI\Client\Model\InvoiceObjectCustomer|null
     */
     ...
     * Sets customer
     *
     * @param \OpenAPI\Client\Model\InvoiceObjectCustomer|null $customer customer
     *
     * @return self
     */
     ...
     * Gets applied_taxes
     *
     * @return \OpenAPI\Client\Model\InvoiceAppliedTaxObject[]|null
     */
     ...
     * Sets applied_taxes
     *
     * @param \OpenAPI\Client\Model\InvoiceAppliedTaxObject[]|null $applied_taxes applied_taxes
     *
     * @return self
     */
