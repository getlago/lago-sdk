...
/**
 * CouponCreateInputCoupon Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CouponCreateInputCoupon implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CouponCreateInput_coupon';
    ...
    protected static $openAPITypes = [
        ...
        'applies_to' => '\OpenAPI\Client\Model\CouponBaseInputAppliesTo'
    ];
    ...
    */
    ...
    public function setPercentageRate($percentage_rate)
    {
        ...
        if (!is_null($percentage_rate) && (!preg_match("/^[0-9]+.?[0-9]*$/", ObjectSerializer::toString($percentage_rate)))) {
            throw new \InvalidArgumentException("invalid value for \$percentage_rate when calling CouponCreateInputCoupon., must conform to the pattern /^[0-9]+.?[0-9]*$/.");
        }
     ...
     * Gets applies_to
     *
     * @return \OpenAPI\Client\Model\CouponBaseInputAppliesTo|null
     */
     ...
     * Sets applies_to
     *
     * @param \OpenAPI\Client\Model\CouponBaseInputAppliesTo|null $applies_to applies_to
     *
     * @return self
     */
