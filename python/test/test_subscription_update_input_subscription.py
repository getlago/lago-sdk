...
class TestSubscriptionUpdateInputSubscription(unittest.TestCase):
    """SubscriptionUpdateInputSubscription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionUpdateInputSubscription:
        """Test SubscriptionUpdateInputSubscription
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionUpdateInputSubscription`
        """
        model = SubscriptionUpdateInputSubscription()
        if include_optional:
            return SubscriptionUpdateInputSubscription(
                name = 'Repository B',
    ...
    def testSubscriptionUpdateInputSubscription(self):
        """Test SubscriptionUpdateInputSubscription"""
