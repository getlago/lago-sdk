...
class TestPlansPaginated(unittest.TestCase):
    """PlansPaginated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlansPaginated:
        """Test PlansPaginated
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlansPaginated`
        """
        model = PlansPaginated()
        if include_optional:
            return PlansPaginated(
                plans = [
                    lago_api.models.plan_object.PlanObject(
