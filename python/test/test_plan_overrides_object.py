...
class TestPlanOverridesObject(unittest.TestCase):
    """PlanOverridesObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlanOverridesObject:
        """Test PlanOverridesObject
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlanOverridesObject`
        """
        model = PlanOverridesObject()
        if include_optional:
            return PlanOverridesObject(
                amount_cents = 10000,
    ...
    def testPlanOverridesObject(self):
        """Test PlanOverridesObject"""
