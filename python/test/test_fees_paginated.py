...
class TestFeesPaginated(unittest.TestCase):
    """FeesPaginated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeesPaginated:
        """Test FeesPaginated
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeesPaginated`
        """
        model = FeesPaginated()
        if include_optional:
