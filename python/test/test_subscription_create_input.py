...
class TestSubscriptionCreateInput(unittest.TestCase):
    """SubscriptionCreateInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionCreateInput:
        """Test SubscriptionCreateInput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionCreateInput`
        """
        model = SubscriptionCreateInput()
        if include_optional:
            return SubscriptionCreateInput(
                subscription = lago_api.models.subscription_create_input_subscription.SubscriptionCreateInput_subscription(
    ...
    def testSubscriptionCreateInput(self):
        """Test SubscriptionCreateInput"""
