...
class TestPlanCreateInput(unittest.TestCase):
    """PlanCreateInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlanCreateInput:
        """Test PlanCreateInput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlanCreateInput`
        """
        model = PlanCreateInput()
        if include_optional:
            return PlanCreateInput(
                plan = lago_api.models.plan_create_input_plan.PlanCreateInput_plan(
                    name = 'Startup', 
