...
class TestCouponBaseInput(unittest.TestCase):
    """CouponBaseInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CouponBaseInput:
        """Test CouponBaseInput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CouponBaseInput`
        """
        model = CouponBaseInput()
        if include_optional:
            return CouponBaseInput(
                name = 'Startup Deal',
                code = 'startup_deal',
