...
class TestPlanCreateInputPlan(unittest.TestCase):
    """PlanCreateInputPlan unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlanCreateInputPlan:
        """Test PlanCreateInputPlan
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlanCreateInputPlan`
        """
        model = PlanCreateInputPlan()
        if include_optional:
            return PlanCreateInputPlan(
                name = 'Startup',
    ...
    def testPlanCreateInputPlan(self):
        """Test PlanCreateInputPlan"""
