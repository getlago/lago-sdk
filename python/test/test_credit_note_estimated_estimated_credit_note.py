...
class TestCreditNoteEstimatedEstimatedCreditNote(unittest.TestCase):
    """CreditNoteEstimatedEstimatedCreditNote unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreditNoteEstimatedEstimatedCreditNote:
        """Test CreditNoteEstimatedEstimatedCreditNote
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreditNoteEstimatedEstimatedCreditNote`
        """
        model = CreditNoteEstimatedEstimatedCreditNote()
        if include_optional:
            return CreditNoteEstimatedEstimatedCreditNote(
    ...
    def testCreditNoteEstimatedEstimatedCreditNote(self):
        """Test CreditNoteEstimatedEstimatedCreditNote"""
