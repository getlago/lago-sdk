...
class TestCreditNoteItemObjectFee(unittest.TestCase):
    """CreditNoteItemObjectFee unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreditNoteItemObjectFee:
        """Test CreditNoteItemObjectFee
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreditNoteItemObjectFee`
        """
        model = CreditNoteItemObjectFee()
        if include_optional:
            return CreditNoteItemObjectFee(
    ...
    def testCreditNoteItemObjectFee(self):
        """Test CreditNoteItemObjectFee"""
