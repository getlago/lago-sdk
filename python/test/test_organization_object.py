...
class TestOrganizationObject(unittest.TestCase):
    """OrganizationObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrganizationObject:
        """Test OrganizationObject
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganizationObject`
        """
    ...
    def testOrganizationObject(self):
        """Test OrganizationObject"""
