...
class TestSubscriptionsPaginated(unittest.TestCase):
    """SubscriptionsPaginated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionsPaginated:
        """Test SubscriptionsPaginated
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionsPaginated`
        """
        model = SubscriptionsPaginated()
        if include_optional:
    ...
    def testSubscriptionsPaginated(self):
        """Test SubscriptionsPaginated"""
