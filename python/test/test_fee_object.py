...
class TestFeeObject(unittest.TestCase):
    """FeeObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeeObject:
        """Test FeeObject
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeeObject`
        """
        model = FeeObject()
        if include_optional:
            return FeeObject(
