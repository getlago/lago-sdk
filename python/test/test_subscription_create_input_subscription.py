...
class TestSubscriptionCreateInputSubscription(unittest.TestCase):
    """SubscriptionCreateInputSubscription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionCreateInputSubscription:
        """Test SubscriptionCreateInputSubscription
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionCreateInputSubscription`
        """
        model = SubscriptionCreateInputSubscription()
        if include_optional:
            return SubscriptionCreateInputSubscription(
    ...
    def testSubscriptionCreateInputSubscription(self):
        """Test SubscriptionCreateInputSubscription"""
