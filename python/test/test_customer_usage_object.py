...
class TestCustomerUsageObject(unittest.TestCase):
    """CustomerUsageObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomerUsageObject:
        """Test CustomerUsageObject
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomerUsageObject`
        """
        model = CustomerUsageObject()
        if include_optional:
            return CustomerUsageObject(
    ...
    def testCustomerUsageObject(self):
        """Test CustomerUsageObject"""
