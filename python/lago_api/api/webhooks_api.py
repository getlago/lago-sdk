...
class WebhooksApi:
    ...
    def fetch_public_key(
        ...
        _param = self._fetch_public_key_serialize(
    ...
    @validate_call
    def fetch_public_key_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def fetch_public_key_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _fetch_public_key_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/webhooks/public_key',
