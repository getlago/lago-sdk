...
class OrganizationsApi:
    ...
    def update_organization(
        self,
        organization_update_input: Annotated[OrganizationUpdateInput, Field(description="Update an existing organization")],
        ...
        :param organization_update_input: Update an existing organization (required)
        :type organization_update_input: OrganizationUpdateInput
        ...
        _param = self._update_organization_serialize(
            organization_update_input=organization_update_input,
    ...
    def _update_organization_serialize(
        ...
        if organization_update_input is not None:
            _body_params = organization_update_input
