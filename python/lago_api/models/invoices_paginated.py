...
class InvoicesPaginated(BaseModel):
    """
    InvoicesPaginated
    """ # noqa: E501
    invoices: List[InvoiceObject]
    meta: PaginationMeta
    __properties: ClassVar[List[str]] = ["invoices", "meta"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "invoices": [InvoiceObject.from_dict(_item) for _item in obj.get("invoices")] if obj.get("invoices") is not None else None,
