...
class SubscriptionObject(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["lago_id", "external_id", "lago_customer_id", "external_customer_id", "billing_time", "name", "plan_code", "status", "created_at", "canceled_at", "started_at", "ending_at", "subscription_at", "terminated_at", "previous_plan_code", "next_plan_code", "downgrade_plan_date"]
