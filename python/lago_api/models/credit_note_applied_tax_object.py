...
class CreditNoteAppliedTaxObject(BaseModel):
    """
    CreditNoteAppliedTaxObject
    """ # noqa: E501
    lago_credit_note_id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the credit note, created by Lago.")
