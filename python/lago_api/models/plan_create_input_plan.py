...
class PlanCreateInputPlan(BaseModel):
    """
    PlanCreateInputPlan
    """ # noqa: E501
    ...
    charges: Optional[List[PlanCreateInputPlanChargesInner]] = Field(default=None, description="Additional usage-based charges for this plan.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "charges": [PlanCreateInputPlanChargesInner.from_dict(_item) for _item in obj.get("charges")] if obj.get("charges") is not None else None
        })
        return _obj
