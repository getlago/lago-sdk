...
class CreditNoteUpdateInput(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "credit_note": CreditNoteUpdateInputCreditNote.from_dict(obj.get("credit_note")) if obj.get("credit_note") is not None else None
        })
        return _obj
