...
class InvoiceAppliedTaxObject(BaseModel):
    """
    InvoiceAppliedTaxObject
    """ # noqa: E501
    lago_invoice_id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the invoice, created by Lago.")
    fees_amount_cents: Optional[StrictInt] = Field(default=None, description="Fees total amount on which the tax is applied")
