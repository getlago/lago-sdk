...
class CouponsPaginated(BaseModel):
    """
    CouponsPaginated
    """ # noqa: E501
    coupons: List[CouponObject]
    meta: PaginationMeta
    __properties: ClassVar[List[str]] = ["coupons", "meta"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "coupons": [CouponObject.from_dict(_item) for _item in obj.get("coupons")] if obj.get("coupons") is not None else None,
