...
class CreditNoteItemObject(BaseModel):
    """
    CreditNoteItemObject
    """ # noqa: E501
    lago_id: StrictStr = Field(description="The credit note’s item unique identifier, created by Lago.")
    amount_cents: StrictInt = Field(description="The credit note’s item amount, expressed in cents.")
    amount_currency: Any
    fee: CreditNoteItemObjectFee
    __properties: ClassVar[List[str]] = ["lago_id", "amount_cents", "amount_currency", "fee"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "fee": CreditNoteItemObjectFee.from_dict(obj.get("fee")) if obj.get("fee") is not None else None
        })
        return _obj
