...
class AddOnCreateInput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["add_on"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.add_on:
            _dict['add_on'] = self.add_on.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "add_on": AddOnCreateInputAddOn.from_dict(obj.get("add_on")) if obj.get("add_on") is not None else None
        })
        return _obj
