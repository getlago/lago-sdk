...
class BillableMetricCreateInput(BaseModel):
    """
    BillableMetricCreateInput
    """ # noqa: E501
    billable_metric: BillableMetricCreateInputBillableMetric
    __properties: ClassVar[List[str]] = ["billable_metric"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "billable_metric": BillableMetricCreateInputBillableMetric.from_dict(obj.get("billable_metric")) if obj.get("billable_metric") is not None else None
        })
        return _obj
