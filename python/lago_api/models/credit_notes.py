...
class CreditNotes(BaseModel):
    ...
    CreditNotes
    """ # noqa: E501
    credit_notes: List[CreditNoteObject]
    __properties: ClassVar[List[str]] = ["credit_notes"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "credit_notes": [CreditNoteObject.from_dict(_item) for _item in obj.get("credit_notes")] if obj.get("credit_notes") is not None else None
        })
        return _obj
