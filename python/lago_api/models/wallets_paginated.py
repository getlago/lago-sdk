...
class WalletsPaginated(BaseModel):
    """
    WalletsPaginated
    """ # noqa: E501
    wallets: List[WalletObject]
    meta: PaginationMeta
    __properties: ClassVar[List[str]] = ["wallets", "meta"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "wallets": [WalletObject.from_dict(_item) for _item in obj.get("wallets")] if obj.get("wallets") is not None else None,
