...
class BillableMetricGroup(BaseModel):
    ...
    """ # noqa: E501
    key: StrictStr = Field(description="Name of the event property used to group values.")
    values: List[BillableMetricGroupValuesInner] = Field(description="Array of strings or objects representing all possible values.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "key": obj.get("key"),
            "values": [BillableMetricGroupValuesInner.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None
        })
        return _obj
