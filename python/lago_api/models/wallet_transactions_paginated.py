...
class WalletTransactionsPaginated(BaseModel):
    """
    WalletTransactionsPaginated
    """ # noqa: E501
    wallet_transactions: List[WalletTransactionObject]
    meta: PaginationMeta
    __properties: ClassVar[List[str]] = ["wallet_transactions", "meta"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.wallet_transactions:
            for _item in self.wallet_transactions:
                if _item:
                    _items.append(_item.to_dict())
            _dict['wallet_transactions'] = _items
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "wallet_transactions": [WalletTransactionObject.from_dict(_item) for _item in obj.get("wallet_transactions")] if obj.get("wallet_transactions") is not None else None,
