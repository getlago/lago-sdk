...
class PlanUpdateInputPlanChargesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "billable_metric_id", "charge_model", "pay_in_advance", "invoiceable", "invoice_display_name", "prorated", "min_amount_cents", "properties", "group_properties", "tax_codes"]
