...
class BillableMetricObject(BaseModel):
    """
    BillableMetricObject
    """ # noqa: E501
    lago_id: StrictStr = Field(description="Unique identifier of the billable metric created by Lago.")
    ...
    recurring: StrictBool = Field(description="Defines if the billable metric is persisted billing period over billing period.  - If set to `true`: the accumulated number of units calculated from the previous billing period is persisted to the next billing period. - If set to `false`: the accumulated number of units is reset to 0 at the end of the billing period. - If not defined in the request, default value is `false`.")
    created_at: datetime = Field(description="Creation date of the billable metric.")
    ...
    active_subscriptions_count: StrictInt = Field(description="Number of active subscriptions using this billable metric.")
    draft_invoices_count: StrictInt = Field(description="Number of draft invoices for which this billable metric is listed as an invoice item.")
    plans_count: StrictInt = Field(description="Number of plans using this billable metric.")
    __properties: ClassVar[List[str]] = ["lago_id", "name", "code", "description", "recurring", "created_at", "field_name", "aggregation_type", "weighted_interval", "group", "active_subscriptions_count", "draft_invoices_count", "plans_count"]
