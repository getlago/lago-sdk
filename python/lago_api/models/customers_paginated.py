...
class CustomersPaginated(BaseModel):
    """
    CustomersPaginated
    """ # noqa: E501
    customers: List[CustomerObjectExtended]
    meta: PaginationMeta
    __properties: ClassVar[List[str]] = ["customers", "meta"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "customers": [CustomerObjectExtended.from_dict(_item) for _item in obj.get("customers")] if obj.get("customers") is not None else None,
