...
class AppliedCouponObject(BaseModel):
    """
    AppliedCouponObject
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["lago_id", "lago_coupon_id", "coupon_code", "coupon_name", "lago_customer_id", "external_customer_id", "status", "amount_cents", "amount_cents_remaining", "amount_currency", "percentage_rate", "frequency", "frequency_duration", "frequency_duration_remaining", "expiration_at", "created_at", "terminated_at"]
