...
class FeeUpdateInputFee(BaseModel):
    """
    FeeUpdateInputFee
    """ # noqa: E501
    payment_status: StrictStr = Field(description="The payment status of the fee. Possible values are `pending`, `succeeded`, `failed` or `refunded`.")
    __properties: ClassVar[List[str]] = ["payment_status"]
