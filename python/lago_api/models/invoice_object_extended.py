...
class InvoiceObjectExtended(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "fees": [FeeObject.from_dict(_item) for _item in obj.get("fees")] if obj.get("fees") is not None else None,
            "subscriptions": [SubscriptionObject.from_dict(_item) for _item in obj.get("subscriptions")] if obj.get("subscriptions") is not None else None
        })
        return _obj
