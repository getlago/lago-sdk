...
class PlansPaginated(BaseModel):
    """
    PlansPaginated
    """ # noqa: E501
    plans: List[PlanObject]
    meta: PaginationMeta
    __properties: ClassVar[List[str]] = ["plans", "meta"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "plans": [PlanObject.from_dict(_item) for _item in obj.get("plans")] if obj.get("plans") is not None else None,
