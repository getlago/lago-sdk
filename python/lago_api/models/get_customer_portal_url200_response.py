...
class GetCustomerPortalUrl200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "customer": GetCustomerPortalUrl200ResponseCustomer.from_dict(obj.get("customer")) if obj.get("customer") is not None else None
        })
        return _obj
