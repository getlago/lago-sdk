...
class BillableMetricUpdateInput(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "billable_metric": BillableMetricBaseInput.from_dict(obj.get("billable_metric")) if obj.get("billable_metric") is not None else None
        })
        return _obj
