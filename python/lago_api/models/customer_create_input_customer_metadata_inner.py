...
class CustomerCreateInputCustomerMetadataInner(BaseModel):
    """
    CustomerCreateInputCustomerMetadataInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Identifier for the metadata object, only required when updating a key-value pair")
    ...
    __properties: ClassVar[List[str]] = ["id", "key", "value", "display_in_invoice"]
